...
void metadatamydsp(MetaGlue* m) { 
	...
	m->declare(m->metaInterface, "filename", "faustlowshelf.dsp");
	...
	m->declare(m->metaInterface, "name", "faustlowshelf");
}
...
void instanceConstantsmydsp(mydsp* dsp, int sample_rate) {
	...
	dsp->fConst0 = (3.14159274f / min(192000.0f, max(1.0f, (float)dsp->fSampleRate)));
}
...
void buildUserInterfacemydsp(mydsp* dsp, UIGlue* ui_interface) {
	ui_interface->openVerticalBox(ui_interface->uiInterface, "faustlowshelf");
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "freq", &dsp->fHslider0, 100.0f, 50.0f, 5000.0f, 1.0f);
	ui_interface->addHorizontalSlider(ui_interface->uiInterface, "gain", &dsp->fHslider1, 0.0f, -48.0f, 48.0f, 0.100000001f);
...
void computemydsp(mydsp* dsp, int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
	...
	float fSlow6 = (0.0f - (1.0f / (fSlow0 * fSlow5)));
	float fSlow7 = (1.0f / fSlow5);
	float fSlow8 = (1.0f - fSlow1);
	float fSlow9 = (((fSlow1 + -1.0f) / fSlow0) + 1.0f);
	float fSlow10 = (2.0f * (1.0f - fSlow4));
	float fSlow11 = (0.0f - (2.0f / fSlow3));
	float fSlow12 = powf(10.0f, (0.0500000007f * (float)dsp->fHslider1));
	/* C99 loop */
	{
		int i;
		for (i = 0; (i < count); i = (i + 1)) {
			...
			dsp->fVec0[0] = fTemp0;
			dsp->fRec1[0] = ((fSlow6 * dsp->fVec0[1]) - (fSlow7 * ((fSlow8 * dsp->fRec1[1]) - (fSlow1 * fTemp0))));
			dsp->fRec0[0] = (dsp->fRec1[0] - (fSlow2 * ((fSlow9 * dsp->fRec0[2]) + (fSlow10 * dsp->fRec0[1]))));
			dsp->fRec3[0] = (0.0f - (fSlow7 * ((fSlow8 * dsp->fRec3[1]) - (fTemp0 + dsp->fVec0[1]))));
			dsp->fRec2[0] = (dsp->fRec3[0] - (fSlow2 * ((fSlow9 * dsp->fRec2[2]) + (fSlow10 * dsp->fRec2[1]))));
			output0[i] = (FAUSTFLOAT)(fSlow2 * ((((fSlow4 * dsp->fRec0[0]) + (fSlow11 * dsp->fRec0[1])) + (fSlow4 * dsp->fRec0[2])) + (fSlow12 * (dsp->fRec2[2] + (dsp->fRec2[0] + (2.0f * dsp->fRec2[1]))))));
