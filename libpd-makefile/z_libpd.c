...
int libpd_init(void) {
  ...
  sigmund_tilde_setup();
  stdout_setup();
  elsedownsample_tilde_setup();
  elsehighshelf_tilde_setup();
  elselowshelf_tilde_setup();
  elsequantizer_tilde_setup();
  faustchorus_tilde_setup();
  faustdelay_tilde_setup();
  faustflange_tilde_setup();
  fausthighshelf_tilde_setup();
  faustlowshelf_tilde_setup();
  faustpeakeq_tilde_setup();
  faustreson_tilde_setup();
  faustrevstereo_tilde_setup();
  fxlist_setup();
  samplelooper_tilde_setup();
#endif
#ifndef LIBPD_NO_NUMERIC
